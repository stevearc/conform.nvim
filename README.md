...
|          | dry_run                                                | `nil\|boolean`                       | If true the buffer won't be edited. Defaults to false. Return values and callback will still reflect whether the formatters would edit the buffer.   |
...
| callback | `nil\|fun(err: nil\|string, did_change: nil\|boolean)` | Called once formatting has completed |                                                                                                                                                      |
...
| boolean | True if any changes were made (nil if async = true) |
