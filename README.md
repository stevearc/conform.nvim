...
|          | dry_run                                                | `nil\|boolean`                       | If true the buffer won't be edited. Defaults to false. `did_edit` argument in callback will still reflect whether the formatters would edit the buffer.|
