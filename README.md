...
require("conform").setup({
  formatters_by_ft = {
    ...
    -- Or stop after the first formatter that succeeds
    python = { "isort", "black", stop_after_success = true },
  },
})
```
...
| >>stop_after_success  | `nil\|boolean`                                                                                                   | Run formatters sequentially and stop after the first one that succeeds (makes a change). Defaults to false.                                                                                                                                                                         |
