...
---@field formatters_by_ft? table<string|string[], conform.FiletypeFormatter> Map of filetype to formatters. It supports tables as keys, works exclusively in conform.setup(); simple keys always override tables as keys.
